...
var PHASES = [
	...
	/*
	 * XXX New phase:
	 *	- generate new hash ring database with half of vnodes
	 *	  remapped to new shard name
	 */

	/*
	 * XXX New phase:
	 *	- create new shard in SAPI INDEX_MORAY_SHARDS
	 *	- mark the target and new shards as read-only in SAPI
	 *	- restart all Electric Morays and confirm that they have
	 *	  the right configuration (pending new E.M. functionality)
	 */
	...
	/*
	 * XXX New phase:
	 *	- deploy Moray instances for the new shard
	 *	- write a sentinel record into the new Moray and check that
	 *	  it replicates through the chain
	 */

	/*
	 * XXX New phase:
	 *	- store the new hash ring database into IMGAPI
	 *	- update the SAPI property which names the current hash ring
	 */
	...
	/*
	 * XXX New phase:
	 *	- mark the target and new shards as writable in SAPI
	 *	- restart all Electric Morays and confirm that they have
	 *	  the right configuration (pending new E.M. functionality)
	 */
